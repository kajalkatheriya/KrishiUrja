...
class RatesPage2 extends StatefulWidget {
  const RatesPage2({Key? key}) : super(key: key);

  @override
  _RatesPage2State createState() => _RatesPage2State();
}

class _RatesPage2State extends State<RatesPage2> {
  final user = FirebaseAuth.instance.currentUser!;

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Jowar Rates')),
        ...
        children: [
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
              stream: FirebaseFirestore.instance.collection('JowarRates')
                  .snapshots(),
                          ...
                          builder: (context) =>
                              AlertDialog(
                                ...
                                content: Column(
                                  ...
                                  children: [
                                    Text(
                                        'Price: ₹ $formattedPrice per quintal'),
                                    Text('City: $cityName'),
                                    // Display the city name in the dialog
                                  ],
                                ),
                              ),
                        );
