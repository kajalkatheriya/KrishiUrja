...
class RatesPage1 extends StatefulWidget {
  const RatesPage1({Key? key}) : super(key: key);

  @override
  _RatesPage1State createState() => _RatesPage1State();
}

class _RatesPage1State extends State<RatesPage1> {
  final user = FirebaseAuth.instance.currentUser!;

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Rice Rates')),
        ...
        children: [
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
              stream: FirebaseFirestore.instance.collection('RiceRates')
                  .snapshots(),
